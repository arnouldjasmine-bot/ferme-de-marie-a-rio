...
function messageWhatsApp(prenom: string, total: number, telephone: string, locale: string): string {
  ...
  const msg = pt
    ? `Olá ${prenom}, tudo bem? 🌿 Passando para lembrar que o pagamento do seu pedido de R$ ${total.toFixed(2)} ainda está pendente. Pode efetuar o pagamento pelo link enviado anteriormente? Obrigada!`
